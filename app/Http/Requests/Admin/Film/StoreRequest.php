...
class StoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'image' => 'required|file',
            'rejisor_id' => 'required|integer|exists:rejisors,id',
